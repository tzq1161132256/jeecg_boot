 ...
 */
@Component
@RabbitListener(queues = RabbitConfig.QUEUE_INSTALMENT)
@Slf4j
public class InstalmentConsumer {
  ...
  IInstalmentService instalmentService;
    ...
    public void process(String sendMsg, Channel channel, Message message) throws Exception {
        ...
        try {
            ...
            Instalment model = JSON.parseObject(sendMsg, Instalment.class);

            instalmentService.processInstalment(model);
