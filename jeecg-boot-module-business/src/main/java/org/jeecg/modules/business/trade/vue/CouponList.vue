<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('优惠券信息')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/trade/coupon/list",
          delete: "/trade/coupon/delete",
          deleteBatch: "/trade/coupon/deleteBatch",
          exportXlsUrl: "trade/coupon/exportXls",
          importExcelUrl: "trade/coupon/importExcel",
       },
    }
  },
  computed: {
