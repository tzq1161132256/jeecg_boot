    ...
    <a-spin :spinning="confirmLoading">
        ...
        <a-row>
          ...
          <a-col :span="12" :gutter="8">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="购药人id">
              <a-input placeholder="请输入购药人id" v-decorator="['buyerid', {}]"/>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
      ...
      <a-tabs v-model="activeKey" @change="handleChangeTabs">
        <a-tab-pane tab="订单明细" :key="refKeys[0]" :forceRender="true">
          <j-editable-table
            :ref="refKeys[0]"
            :loading="orderdetailAllTable.loading"
            :columns="orderdetailAllTable.columns"
            :dataSource="orderdetailAllTable.dataSource"
            :maxHeight="300"
            :rowNumber="true"
            :rowSelection="true"
            :actionButton="true"/>
  ...
  export default {
    ...
    data() {
      return {
        ...
        refKeys: ['orderdetailAll', ],
        activeKey: 'orderdetailAll',
        // 订单明细
        orderdetailAllTable: {
          loading: false,
          dataSource: [],
        ...
        url: {
          add: "/trade/orderAll/add",
          edit: "/trade/orderAll/edit",
          orderdetailAll: {
            list: '/trade/orderAll/queryOrderdetailAllByMainId'
          },
        }
      }
    },
    methods: {
      ...
      editAfter() {
        ...
        if (this.model.id) {
          ...
          this.requestSubTableData(this.url.orderdetailAll.list, params, this.orderdetailAllTable)
        }
      },
      ...
      classifyIntoFormData(allValues) {
        ...
        return {
          ...main, // 展开
          orderdetailAllList: allValues.tablesValue[0].values,
        }
      }
    }
  }
