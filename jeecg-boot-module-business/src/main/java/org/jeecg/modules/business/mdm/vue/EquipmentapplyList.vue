<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('ipad领用信息')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <equipmentapply-modal ref="modalForm" @ok="modalFormOk"></equipmentapply-modal>
  </a-card>
</template>

<script>
  import EquipmentapplyModal from './modules/EquipmentapplyModal'
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'

  export default {
    name: "EquipmentapplyList",
    ...
    data () {
      return {
		...
		url: {
          list: "/mdm/equipmentapply/list",
          delete: "/mdm/equipmentapply/delete",
          deleteBatch: "/mdm/equipmentapply/deleteBatch",
          exportXlsUrl: "mdm/equipmentapply/exportXls",
          importExcelUrl: "mdm/equipmentapply/importExcel",
       },
    }
  },
  computed: {
