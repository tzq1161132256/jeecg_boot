 ...
 */
@Component
@RabbitListener(queues = RabbitConfig.QUEUE_PRESCRIPTION)
@Slf4j
  ...
  IPrescriptionService prescriptionService;
    ...
    public void process(String sendMsg, Channel channel, Message message) throws Exception {
        ...
        try {
            ...
            Prescription model = JSON.parseObject(sendMsg, Prescription.class);
            model.setCreateTime(new Date());
            model.setUpdateTime(new Date());
            prescriptionService.processPrescription(model);
