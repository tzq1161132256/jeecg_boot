    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="保单状态">
          <a-input placeholder="请输入保单状态" v-decorator="['status', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
...
<script>
  ...
  export default {
    name: "InsuranceZhaoshangrenheModal",
    data () {
      return {
        title:"操作",
        visible: false,
        ...
        url: {
          add: "/insurance/insuranceZhaoshangrenhe/add",
          edit: "/insurance/insuranceZhaoshangrenhe/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'policyno','status'))
		  //时间格式化
