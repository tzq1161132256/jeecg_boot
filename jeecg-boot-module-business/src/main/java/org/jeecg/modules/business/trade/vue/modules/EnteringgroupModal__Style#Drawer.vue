  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/trade/enteringgroup/add",
          edit: "/trade/enteringgroup/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'projectname','username','mobile','status','delFlag'))
		  //时间格式化
