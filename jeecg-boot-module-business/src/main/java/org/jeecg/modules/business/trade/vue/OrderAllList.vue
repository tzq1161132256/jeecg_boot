<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <orderAll-modal ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import OrderAllModal from './modules/OrderAllModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        // 请求参数
    	url: {
              list: "/trade/orderAll/list",
              delete: "/trade/orderAll/delete",
              deleteBatch: "/trade/orderAll/deleteBatch",
              exportXlsUrl: "trade/orderAll/exportXls",
              importExcelUrl: "trade/orderAll/importExcel",
           },
        }
      },
      computed: {
