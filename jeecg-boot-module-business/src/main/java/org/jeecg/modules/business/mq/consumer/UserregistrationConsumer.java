 ...
 */
@Component
@RabbitListener(queues = RabbitConfig.QUEUE_USERREGISTRATION)
@Slf4j
  ...
  IUserregistrationService userregistrationService;
    ...
    public void process(String sendMsg, Channel channel, Message message) throws Exception {
        ...
        try {
            ...
            Userregistration model = JSON.parseObject(sendMsg, Userregistration.class);

            userregistrationService.processUserregistration(model);
