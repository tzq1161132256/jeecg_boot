        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="会员卡">
              <a-input placeholder="请输入会员卡" v-model="queryParam.membershipcard"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
		   {
            title: '推荐药房',
            align:"center",
            dataIndex: 'drugstorenamereferee'
           },
		   {
            title: '备注',
            align:"center",
		...
		url: {
          list: "/trade/member/list",
          delete: "/trade/member/delete",
          deleteBatch: "/trade/member/deleteBatch",
          exportXlsUrl: "trade/member/exportXls",
          importExcelUrl: "trade/member/importExcel",
       },
    }
  },
  computed: {
