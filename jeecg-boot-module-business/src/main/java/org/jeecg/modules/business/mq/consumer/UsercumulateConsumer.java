 ...
 */
@Component
@RabbitListener(queues = RabbitConfig.QUEUE_USERCUMULATE)
@Slf4j
public class UsercumulateConsumer {
  //  private final Logger logger = LoggerFactory.getLogger(this.getClass());
    @Autowired
    IUsercumulateService usercumulateService;
    ...
    public void process(String sendMsg, Channel channel, Message message) throws Exception {
        ...
        try {
            ...
            Usercumulate model = JSON.parseObject(sendMsg, Usercumulate.class);
