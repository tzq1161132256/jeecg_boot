 ...
 */
@Component
@RabbitListener(queues = RabbitConfig.QUEUE_EQUIPMENTAPPLY)
@Slf4j
public class EquipmentapplyConsumer {
  //  private final Logger logger = LoggerFactory.getLogger(this.getClass());
    @Autowired
  IEquipmentapplyService equipmentapplyService;
    ...
    public void process(String sendMsg, Channel channel, Message message) throws Exception {
        ...
        try {
            ...
            Equipmentapply model = JSON.parseObject(sendMsg, Equipmentapply.class);

            equipmentapplyService.processEquipmentapply(model);
