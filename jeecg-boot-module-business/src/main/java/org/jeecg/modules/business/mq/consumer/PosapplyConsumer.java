 ...
 */
@Component
@RabbitListener(queues = RabbitConfig.QUEUE_POS_APPLY)
@Slf4j
public class PosapplyConsumer {
  ...
  IPosapplyService posapplyService;
    ...
    public void process(String sendMsg, Channel channel, Message message) throws Exception {
        ...
        try {
            ...
            Posapply model = JSON.parseObject(sendMsg, Posapply.class);

            posapplyService.processPosapply(model);
